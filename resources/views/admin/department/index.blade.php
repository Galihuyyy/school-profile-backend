    ...
    <section x-data="departmentPage(@js($departments->items()))">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            @if (hasPermission('manage_department'))
                <a href="{{ route('admin::departments.create') }}" class="flex items-center gap-2 px-5 py-2.5 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-sm font-bold transition-colors shadow-sm whitespace-nowrap">
